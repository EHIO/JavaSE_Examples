package org.wg.containers.set;//: containers/TypesForSets.java
...
public class TypesForSets {
    ...
    public static void main(String[] args) {
        ...
        /*
         * 对于没有重写hashCode方法的SetType和TreeType,
         * HashSet容器中产生重复值
         */
        ...
        /*
         SetType和HashType没有实现java.lang.Comparable接口
         下面论证了TreeSet容器中的对象需实现java.lang.Comparable接口
         */
        try {
